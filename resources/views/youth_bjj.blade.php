@extends('layouts.base', ['pageTitle' => __('app.youth_bjj.title')])
@section('content')
...
<div class="container mt-3">
  ...
  >
    ...
    @lang('app.youth_bjj.modal_schedule_show')
  </button>
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-4 mb-3">
      ...
      @foreach([1] as $i)
        <p>
          <img class="img-fluid rounded" data-src="/images/youth-bjj/{{ $i }}.jpg">
        </p>
      @endforeach
    </div>
  </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">
          <i class="fa fa-calendar-alt"></i>
          @lang('app.youth_bjj.modal_schedule_title')
        </h5>
